...
class CustomPostType
{
    ...
    public function addCapabilitiesToRole($roleName)
    {
        ...
        $role->add_cap( 'edit_others_' .  $this->key . 's' );
    ...
    public function getOptions()
    {
        ...
        $arguments['labels'] = array(
            'name'                     => sprintf(/* translators: %s: Post type name */__( '%ss', 'stmartin-wof'), $this->label),
            'menu_name'                => sprintf(/* translators: %s: Post type name */__( '%ss', 'stmartin-wof'), $this->label),
            'singular_name'            => $this->label,
            'add_new'                  => __( 'Add New', 'stmartin-wof'),
            'add_new_item'             => sprintf(/* translators: %s: Post type name */__( 'Add New %s', 'stmartin-wof'), $this->label),/*Nouveau %s*/
            'edit_item'                => sprintf(/* translators: %s: Post type name */__( 'Edit %s', 'stmartin-wof'), $this->label),/*Éditer %s*/
            'new_item'                 => sprintf(/* translators: %s: Post type name */__( 'New %s', 'stmartin-wof'), $this->label),/*Nouveau %s*/
            'view_item'                => sprintf(/* translators: %s: Post type name */__( 'View %s', 'stmartin-wof'), $this->label),/*Voir %s*/
            'view_items'               => sprintf(/* translators: %s: Post type name */__( 'View %ss', 'stmartin-wof'), $this->label),/*Voir %ss*/
            'search_items'             => sprintf(/* translators: %s: Post type name */__( 'Search %ss', 'stmartin-wof'), $this->label),/*Rechercher %ss*/
            'not_found'                => sprintf(/* translators: %s: Post type name */__( 'No %ss found.', 'stmartin-wof'), $this->label),/*Aucun %s trouvé.*/
            'not_found_in_trash'       => sprintf(/* translators: %s: Post type name */__( 'No %ss found in Trash.', 'stmartin-wof'), $this->label),/*Aucun %s trouvé dans la corbeille.*/
            'parent_item_colon'        => null,
            'all_items'                => sprintf(/* translators: %s: Post type name */__( 'All %ss', 'stmartin-wof'), $this->label),/*Tous les %ss*/
            'archives'                 => sprintf(/* translators: %s: Post type name */__( '%s Archives', 'stmartin-wof'), $this->label),/*Répertoire des %ss*/
            'attributes'               => sprintf(/* translators: %s: Post type name */__( '%s Attributs', 'stmartin-wof'), $this->label),/*Caractéristiques des %ss*/
            'insert_into_item'         => sprintf(/* translators: %s: Post type name */__( 'Insert into %s', 'stmartin-wof'), $this->label),/*Insérer dans %s*/
            'uploaded_to_this_item'    => sprintf(/* translators: %s: Post type name */__( 'Uploaded to this %s', 'stmartin-wof'), $this->label),/*Télécharger vers %s*/
            //'featured_image'           => sprintf(/* translators: %s: Post type name */__( 'Featured image', 'stmartin-wof'), $this->label),
            //'set_featured_image'       => sprintf(/* translators: %s: Post type name */__( 'Set featured image', 'stmartin-wof'), $this->label),
            //'remove_featured_image'    => sprintf(/* translators: %s: Post type name */__( 'Remove featured image', 'stmartin-wof'), $this->label),
            //'use_featured_image'       => sprintf(/* translators: %s: Post type name */__( 'Use as featured image', 'stmartin-wof'), $this->label),
            'filter_items_list'        => sprintf(/* translators: %s: Post type name */__( 'Filter %ss list', 'stmartin-wof'), $this->label),/*Filtrer la liste des %ss*/
            'items_list_navigation'    => sprintf(/* translators: %s: Post type name */__( '%ss list navigation', 'stmartin-wof'), $this->label),/*Parcours des %ss*/
            'items_list'               => sprintf(/* translators: %s: Post type name */__( '%ss list', 'stmartin-wof'), $this->label),/*Liste des %ss*/
            'item_published'           => sprintf(/* translators: %s: Post type name */__( '%s published.', 'stmartin-wof'), $this->label),/*%s publié.*/
            'item_published_privately' => sprintf(/* translators: %s: Post type name */__( '%s published privately.', 'stmartin-wof'), $this->label),/*%s publié en privé.*/
            'item_reverted_to_draft'   => sprintf(/* translators: %s: Post type name */__( '%s reverted to draft.', 'stmartin-wof'), $this->label),/*%s rétabli comme brouilon.*/
            'item_scheduled'           => sprintf(/* translators: %s: Post type name */__( '%s scheduled.', 'stmartin-wof'), $this->label),/*%s programmé.*/
            'item_updated'             => sprintf(/* translators: %s: Post type name */__( '%s updated.', 'stmartin-wof'), $this->label),/*%s mis à jour.*/
        );
