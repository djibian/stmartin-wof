    ...
    public function displayAddForm( $taxonomy ) {
		?>
            <div class="form-field term-name-wrap">
                <label for="<?php echo esc_attr($this->keyName)?>"><?php echo esc_html($this->label)?></label>
                <input type="text" name="<?php echo esc_attr($this->keyName)?>" id="<?php echo esc_attr($this->keyName)?>" />
            </div>
		<?php
    }
    ...
    public function displayEditForm($taxonomy)
    {
		...
		?>
			<tr class="form-field term-name-wrap">
			    <th scope="row"><label for="<?php echo esc_attr($this->keyName)?>"><?php echo esc_html($this->label)?></label></th>
			    <td>
				    <input name="<?php echo esc_attr($this->keyName)?>" id="<?php echo esc_attr($this->keyName)?>" type="text" value="<?php echo esc_attr($value)?>" size="40" aria-required="true">
			    </td>
			</tr>
		<?php
    }
