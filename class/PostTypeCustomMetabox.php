...
class PostTypeCustomMetabox
{
    ...
    public function addMetaboxesToPostType()
    {
        add_meta_box(
            ...
            $this->label,    // Etiquette de la metabox
    ...
    ?>
        ...
        <p>
        <label for="post<?php echo esc_attr($this->keyName); ?>div"><?php esc_html_e( "Edit your text", 'stmartin-wof' ); ?></label>
        <br />
        <input class="widefat" type="text" name="<?php echo esc_attr($this->keyName); ?>" id="post<?php echo esc_attr($this->keyName); ?>div" value="<?php echo esc_attr( $this->getValue( $post->ID ) ); ?>" size="30" />
        </p>
